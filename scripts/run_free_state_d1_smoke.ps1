...
param(
    ...
    [ValidateSet("neutral", "frequency", "compression", "leveling", "sibilance", "transient", "pan", "limiter")]
    [string]$PromptFlavor = "neutral",
    [ValidateSet("any", "track_gain", "static_eq", "broadband_compression", "de_esser", "transient_shaper", "pan", "limiter")]
