...
def report_markdown(run_dir: Path, analyzed: list[dict[str, Any]],
    ...
    lines += [
        ...
        f"- learn/profile：{audit.get('learning_call_count', 'unknown')}/{audit.get('profile_call_count', 'unknown')}",
        f"- SPAL/B4：{audit.get('spal_call_count', 'unknown')}/{audit.get('b4_call_count', 'unknown')}",
