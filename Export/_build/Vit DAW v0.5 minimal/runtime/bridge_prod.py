...
def main():
    ...
    req_timeout_ms = int(os.getenv('VIT_BRIDGE_REQ_TIMEOUT_MS', overrides.get('req_timeout_ms', 120000)))
    ...
    last_log_path = os.getenv('VIT_BRIDGE_LAST_LOG_PATH', overrides.get('last_log_path', str(logs_dir / 'bridge_last.log')))
