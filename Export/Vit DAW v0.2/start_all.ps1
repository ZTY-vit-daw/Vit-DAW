...
$bridgeProc = Start-Process -FilePath $PythonExe -ArgumentList $bridgeArgs -WorkingDirectory $Runtime -PassThru -RedirectStandardOutput $BridgeStdOut -RedirectStandardError $BridgeStdErr
